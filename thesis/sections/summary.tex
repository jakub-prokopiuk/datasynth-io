...
\begin{itemize}
    \item \textbf{Hybrydowy Silnik Generujący}: Stworzono elastyczny mechanizm łączący bibliotekę Faker, szablony Jinja2 oraz modele LLM (OpenAI/Ollama). Pozwala to na generowanie danych o dowolnym stopniu skomplikowania – od prostych typów liczbowych po złożone opisy tekstowe.
...
\begin{enumerate}
    ...
    \item \textbf{Inteligentne wykrywanie typów}: Wykorzystanie LLM do automatycznej sugestii typów danych na podstawie samej nazwy kolumny (np. wpisując nazwę "pesel", system sam proponuje odpowiedni generator regex).
\end{enumerate}
