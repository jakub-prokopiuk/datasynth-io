...
\begin{itemize}
    ...
    \item Wydajność: Dzięki zastosowaniu architektury asynchronicznej (Celery + Redis), system jest w stanie obsłużyć generowanie tysięcy rekordów bez blokowania interfejsu użytkownika.
