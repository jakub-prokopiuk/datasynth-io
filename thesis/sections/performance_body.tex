...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|p{7cm}|}
        ...
        \hline
        1                            & $\sim$\,130       & Jeden wiersz na raz --- wersja początkowa                \\
        \hline
        2                            & $\sim$\,219       & Wiele równoległych zapytań, ale nadal po jednym wierszu  \\
        \hline
        3                            & $\sim$\,63        & Kilka wierszy łączonych w jedno zapytanie (pakietowanie) \\
        \hline
        4                            & $\sim$\,124       & Pakietowanie z niekorzystnymi rozmiarami paczek          \\
        \hline
        5                            & $\sim$\,52        & Pakietowanie po 15 wierszy, maksymalnie 8 zapytań naraz  \\
        \hline
    \end{tabular}
