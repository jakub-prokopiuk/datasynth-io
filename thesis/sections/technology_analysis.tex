...
Zastosowanie konteneryzacji było wymogiem niefunkcjonalnym, mającym na celu zapewnienie powtarzalności środowiska uruchomieniowego \cite{docker}. Definicja środowiska w pliku \texttt{docker-compose.yml} pozwala na uruchomienie całego stosu (Backend, Frontend, Baza Danych, Redis, Worker, \gls{LLM} Server) jedną komendą, eliminując problem ,,u mnie działa''\cite{it_works}.
