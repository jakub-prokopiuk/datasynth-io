...
Praca została podzielona na następujące rozdziały. Rozdział dotyczący analizy technologii przedstawia porównanie frameworków backendowych i frontendowych. Kolejny rozdział definiuje wymagania i funkcjonalność systemu. Następnie opisano metodykę pracy, szczegóły implementacji, wyniki testów oraz wyzwania związane m.in. z optymalizacją generowania przez \gls{LLM}. Pracę zamyka rozdział podsumowujący uzyskane rezultaty i możliwe kierunki dalszego rozwoju.
