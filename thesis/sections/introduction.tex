...
\begin{itemize}
    ...
    \item testy poprawności, wydajności oraz bezpieczeństwa,
    \item omówienie napotkanych problemów implementacyjnych i wniosków końcowych.
\end{itemize}

Praca została podzielona na następujące rozdziały. Rozdział dotyczący analizy technologii przedstawia porównanie frameworków backendowych i frontendowych. Kolejny rozdział definiuje wymagania i funkcjonalność systemu. Następnie opisano metodykę pracy oraz szczegóły implementacji. Pracę zamyka rozdział obejmujący weryfikację systemu (testy poprawności, bezpieczeństwa i wydajności), omówienie napotkanych wyzwań implementacyjnych oraz podsumowanie uzyskanych rezultatów. Kod źródłowy aplikacji zamieszczono w załączniku.
